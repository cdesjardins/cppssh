...
public:
    ...
    ~CppsshConnection();
    CppsshConnectStatus_t connect(const char* host, const uint16_t port, const char* username, const char* privKeyFile, const char* password, const bool x11Forwarded, const bool keepAlives, const char* term);
